package com.Timetable.bottomfragment;
...
public class taskfragment extends BottomSheetDialogFragment {
    ...
    public void setTaskId(int taskid, boolean Edited, setRefreshListener setRefreshListener, TaskMain activity) {
        this.taskid = taskid;
        this.Edited = Edited;
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        View contentView = View.inflate(getContext(), R.layout.task_fragment, null);
        ...
        taskDate.setOnTouchListener((view, motionEvent) -> {
            if(motionEvent.getAction() == MotionEvent.ACTION_UP) {
                ...
                datePickerDialog = new DatePickerDialog(getActivity(), (view1, year, monthOfYear, dayOfMonth) -> { taskDate.setText(dayOfMonth + "-" + (monthOfYear + 1) + "-" + year);
                datePickerDialog.dismiss(); }, year, month, day);
    ...
    private void createTask() {
        class saveTaskInBackend extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                if (!Edited)
                    Database.getInstance(getActivity()).getDatabaseHelper()
                            .databaseAction()
    ...
    private void showTaskFromId() {
        class showTaskFromId extends AsyncTask<Void, Void, Void> {
            ...
            @Override
            protected Void doInBackground(Void... voids) {
                task = Database.getInstance(getActivity()).getDatabaseHelper()
