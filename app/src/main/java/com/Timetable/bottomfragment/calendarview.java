...
public class calendarview extends BottomSheetDialogFragment {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        View contentView = View.inflate(getContext(), R.layout.calendar_fargment, null);
    ...
    private void getSavedTasks() {
        ...
        class GetSavedTasks extends AsyncTask<Void, Void, List<Task>> {
            ...
            protected List<Task> doInBackground(Void... voids) {
                tasks = Database.getInstance(getActivity()).getDatabaseHelper().databaseAction().getAllTasksList();
                return tasks;
            }
