...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    taskfragment.setRefreshListener setRefreshListener;

    public TaskAdapter(TaskMain context, List<Task> taskList, taskfragment.setRefreshListener setRefreshListener) {
        ...
        popupMenu.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                ...
                case R.id.menuUpdate:
                    ...
                    taskfragment.setTaskId(task.getTaskId(), true, context, context);
                    taskfragment.show(context.getSupportFragmentManager(), taskfragment.getTag());
                    break;
    ...
    public void showCompleteDialog(int taskId, int position) {
        ...
        Button close = dialog.findViewById(R.id.done);
